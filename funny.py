...
while True:
    ...
    engine.say(f"Wow you fucking suck at drawing. I'm awesome though. I think this is {labels[best]}. I am {guesses[best] * 100:.4f}% sure! And I'm probably fucking right.")
    engine.runAndWait()
